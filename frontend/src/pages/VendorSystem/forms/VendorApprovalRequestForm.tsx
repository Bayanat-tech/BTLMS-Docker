        ...
        <Paper elevation={1}>
          ...
          {activeTab === 1 && (
            <Box sx={{ p: 2, maxWidth: '100%' }}>
              <VendorItemDetails vendorDetails={vendorDetails} hideReset={!showResetButton} requestNumber={requestData?.DOC_NO} docNo={requestData?.DOC_NO} refDocNo={requestData?.REF_DOC_NO}  />
            </Box>
          )}
        </Paper>
