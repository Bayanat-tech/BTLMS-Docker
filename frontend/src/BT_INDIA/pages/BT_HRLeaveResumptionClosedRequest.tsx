...
const BTHRLeaveResumptionClosedRequest: FC<HRLClosedRequestProps> = ({}) => {
  ...
  const {
    ...
    queryFn: () => BTHrServiceInstance.getMasters('hr', 'BT_Pg_leave_flow_close', paginationData, filterData, user?.loginid1),
