...
const BTHRLeaveResumptionCancelRequest: FC<HRLCancelRequestProps> = ({ }) => {
  const intl = useIntl();
  ...
  const {
    ...
    queryFn: () => BTHrServiceInstance.getMasters('hr', 'BT_Pg_leave_flow_cancel', paginationData, filterData, user?.loginid1),
...
export default BTHRLeaveResumptionCancelRequest;
