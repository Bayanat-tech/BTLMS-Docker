...
const BTLeaveResumptionApprovalPage = () => {
  const { user } = useAuth();
...
`;
  ...
  const { data, refetch, isError } = useQuery({
    queryKey: ['BT_Pg_Leave_flow', paginationData, filterData, user?.loginid1, sql_string],
...
export default BTLeaveResumptionApprovalPage;
