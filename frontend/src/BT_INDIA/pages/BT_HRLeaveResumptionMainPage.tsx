...
import LeaveResumptionApprovalPage from '../pages/BT_LeaveResumptionApprovalPage';
import HRLeaveResumptionInProgress from '../pages/BT_HRLeaveResumptionInProgress';
import HRLeaveResumptionClosedRequest from '../pages/BT_HRLeaveResumptionClosedRequest';
import HRLeaveResumptionCancelRequest from '../pages/BT_HRLeaveResumptionCancelRequest';
// import HRLeaveResumptionRejectedRequest from './HRLeaveResumptionRejectedRequest';
import { useIntl } from 'react-intl';

const BTHRLeaveResumptionMainPage = () => {
...
export default BTHRLeaveResumptionMainPage;
