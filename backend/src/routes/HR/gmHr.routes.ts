...
import { BTgetLeaveEntitleHandler, BTvalidateLeaveHandler, getBTEmployeesHandler , BTleaveDaysCntHandler } from "../../BT_INDIA/controllers/BThr_net.controller";
...
router.get("/BTleavedayscount", BTleaveDaysCntHandler);
